...
class SpyQueueProcessTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'src.Orm.Zed.Queue.Persistence.Map.SpyQueueProcessTableMap';
     ...
     */
    public const CLASS_DEFAULT = 'src.Orm.Zed.Queue.Persistence.SpyQueueProcess';
    ...
    public function initialize(): void
    {
        ...
        $this->setPackage('src.Orm.Zed.Queue.Persistence');
