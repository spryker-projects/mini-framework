...
class ProductDescriptionBackendApiRouteProviderPlugin extends AbstractPlugin implements RouteProviderPluginInterface
{
    ...
    {
        return (new Route('/product-description'))->setDefaults(['_controller' => [ProductDescriptionResourceController::class, 'getAction'], '_resourceName' => 'ProductDescription'])->setMethods(Request::METHOD_GET);
    }
}
