...
class ProductAbstractStoreHydratorStep implements DataImportStepInterface
{
     ...
     * @var string
     */
    public const DATA_PRODUCT_ABSTRACT_STORE_ENTITY = 'DATA_PRODUCT_ABSTRACT_STORE_ENTITY';
    ...
    {
        $dataSet[static::DATA_PRODUCT_ABSTRACT_STORE_ENTITY] = [
            'storeName' => $dataSet[static::COLUMN_STORE_NAME],
            'productAbstractSku' => $dataSet[static::COLUMN_ABSTRACT_SKU],
        ];
    }
}
